...
env.reset()
goal_steps = 200 #200 might be enough
score_requirement = 50
initial_games = 1000  #1000
...
for each_game in range(20):
    ...
    for _ in range(goal_steps):
        ...
        score += reward
        if done:
            print("GAME OVER Game: ",each_game,"  ",score)
            break
    scores.append(score)
